#!/usr/bin/env python3
"""
FFN ZOGD/NTK on CIFAR-10 binary classification.
Reproduces FFN_zo_fo_cifar.
"""
...
def main():
    ...
    parser.add_argument("--digit_neg", type=int, default=2)
    parser.add_argument("--digit_pos", type=int, default=9)
    ...
    parser.add_argument("--out_dir", type=str, default="output_ffn_cifar")
    ...
    train_data, train_label = load_cifar_binary(
    ...
    output_folder = os.path.join(
        args.out_dir, f"cifar_{args.resolution}_{args.digit_neg}_{args.digit_pos}"
    )
