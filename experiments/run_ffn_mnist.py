#!/usr/bin/env python3
"""
FFN ZOGD/NTK on MNIST binary classification (e.g. 3 vs 5).
Reproduces FFN_zo_fo_mnist.
"""
...
def main():
    ...
    parser.add_argument("--digit_neg", type=int, default=3)
    parser.add_argument("--digit_pos", type=int, default=5)
    ...
    parser.add_argument("--out_dir", type=str, default="output_ffn_mnist")
    ...
    train_data, train_label = load_mnist_binary(
        args.digit_neg, args.digit_pos, args.sample_per_class, args.resolution, args.seed
    )
    ...
    # Standard ZO in parameter space (as in original notebook)
    ...
    output_folder = os.path.join(
        args.out_dir, f"mnist_{args.resolution}_{args.digit_neg}_{args.digit_pos}"
    )
